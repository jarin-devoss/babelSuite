...
notify_smoke = test.run(file="notify_smoke.py", image="python:3.12", after=[notification_api, dispatcher], exports=[{"path": "reports/junit.xml", "name": "notify-test-report", "on": "always", "format": "junit"}])
